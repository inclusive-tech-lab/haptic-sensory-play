...
public class SandboxHapticsScript : MonoBehaviour
{
    ...
    void InitHaptics()
    {
        ...
        {
            case "WaterMesh":
                Debug.Log("Activating water mesh.");
                imagePath = "water-texture";
                break;
            case "SandMesh":
                Debug.Log("Activating sand mesh.");
                imagePath = "noise_texture";
                break;
            case "SlimeMesh":
                Debug.Log("Activating slime mesh.");
                imagePath = "slime-texture";
                break;
        }
