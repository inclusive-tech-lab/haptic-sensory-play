...
public class FeelLetterHapticsScript : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        //Change the background img according to the selected letter.
        string backgroundPath = "Letters/big-letter-" + MenuScript.chosenLetter;

        /*switch (MenuScript.chosenLetter)
        {
            case 'c':
                Debug.Log("Letter selected was C.");
                backgroundPath = "Letters/big-letter-c";
                break;
            case 'm':
                Debug.Log("Letter selected was M.");
                backgroundPath = "Letters/big-letter-m";
                break;
            case 'r':
                Debug.Log("Letter selected was R.");
                backgroundPath = "Letters/big-letter-r";
                break;
            case 't':
                Debug.Log("Letter selected was T.");
                backgroundPath = "Letters/big-letter-t";
                break;
        }*/
